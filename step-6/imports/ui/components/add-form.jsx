    ...
    return (
      <div className="container">
          ...
          <div className="row">
      		    ...
      		    <div className="form-group col-lg-4">
      			    <label htmlFor="numOf50s">Number of 50s</label>
      		...
      		<div className="row">
      			<div className="form-group col-lg-4">
      			    <label htmlFor="numOf100s">No of 100s</label>
      			...
      			<div className="form-group col-lg-4">
      			    <label htmlFor="totalBalls">Total Balls Played</label>
